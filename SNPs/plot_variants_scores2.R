...
#Check the original scripts here:
#https://github.com/hputnam/Coral_Stress_Phenome/blob/main/Genotype_Analysis/Pocillopora_acuta_PacBio_Assembly/RNAseq_short_variant_analysis/filtering/plot_variants_scores.R
