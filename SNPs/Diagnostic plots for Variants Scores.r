...
VCFsnps <- read.csv('/data/home/mass/fscucchia/Bermuda/output/Variant_Filtration/GVCFall_SNPs.table', header = T, na.strings=c("","NA"), sep = "\t") 
VCFindel <- read.csv('/data/home/mass/fscucchia/Bermuda/output/Variant_Filtration/GVCFall_INDELs.table', header = T, na.strings=c("","NA"), sep = "\t")
dim(VCFsnps)
[1] 949411     11
dim(VCFindel)
[1] 230546     11
...
svg("/data/home/mass/fscucchia/Bermuda/output/Variant_Filtration/Diag_plots.svg", height=20, width=15)
